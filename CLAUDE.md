...
- `server/api/` : Nitro API 라우트 (폴더·페이지 CRUD)
- `server/utils/` : DB 클라이언트, 유틸리티
- `shared/types/` : 프론트·백 공유 타입 (SavedFolder, SavedPage)
- `shared/schemas/` : Zod 스키마 (입력 검증)
